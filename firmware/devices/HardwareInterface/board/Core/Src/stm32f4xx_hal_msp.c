...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==ADC1)
  {
    ...
    PA1     ------> ADC1_IN1
    */
    GPIO_InitStruct.Pin = ANALOG_IN1_Pin|ANALOG_IN2_Pin;
  ...
  else if(hadc->Instance==ADC2)
  {
    ...
    PA5     ------> ADC2_IN5
    */
    GPIO_InitStruct.Pin = SERVO1_ADC_Pin|SERVO2_ADC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PA1     ------> ADC1_IN1
    */
    HAL_GPIO_DeInit(GPIOA, ANALOG_IN1_Pin|ANALOG_IN2_Pin);
  ...
  else if(hadc->Instance==ADC2)
  {
    ...
    PA5     ------> ADC2_IN5
    */
    HAL_GPIO_DeInit(GPIOA, SERVO1_ADC_Pin|SERVO2_ADC_Pin);
...
void HAL_TIM_IC_MspInit(TIM_HandleTypeDef* htim_ic)
{
  ...
  if(htim_ic->Instance==TIM4)
  {
    ...
    */
    ...
    __HAL_LINKDMA(htim_ic,hdma[TIM_DMA_ID_CC3],hdma_tim4_ch3);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  else if(htim->Instance==TIM4)
  {
    ...
    PD15     ------> TIM4_CH4
    */
    GPIO_InitStruct.Pin = LED1_PWM_Pin|LED2_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM4;
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* htim_ic)
{
  if(htim_ic->Instance==TIM4)
  {
    ...
    PD15     ------> TIM4_CH4
    */
    HAL_GPIO_DeInit(GPIOD, GPIO_PIN_12|GPIO_PIN_13|LED1_PWM_Pin|LED2_PWM_Pin);
