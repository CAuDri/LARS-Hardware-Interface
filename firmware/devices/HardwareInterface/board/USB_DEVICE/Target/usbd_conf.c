...
void HAL_PCD_MspInit(PCD_HandleTypeDef* pcdHandle)
{
  ...
  /* USER CODE END USB_OTG_FS_MspInit 0 */
    ...
    PA12     ------> USB_OTG_FS_DP
    */
    GPIO_InitStruct.Pin = USB1_VBUS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(USB1_VBUS_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = USB1_D__Pin|USB1_D_A12_Pin;
  ...
  /* USER CODE END USB_OTG_HS_MspInit 0 */
    ...
    PB15     ------> USB_OTG_HS_DP
    */
    GPIO_InitStruct.Pin = USB2_VBUS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(USB2_VBUS_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = USB2_D__Pin|USB2_D_B15_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_PCD_MspDeInit(PCD_HandleTypeDef* pcdHandle)
{
  ...
  /* USER CODE END USB_OTG_FS_MspDeInit 0 */
    ...
    PA12     ------> USB_OTG_FS_DP
    */
    HAL_GPIO_DeInit(GPIOA, USB1_VBUS_Pin|USB1_D__Pin|USB1_D_A12_Pin);
  ...
  /* USER CODE END USB_OTG_HS_MspDeInit 0 */
    ...
    PB15     ------> USB_OTG_HS_DP
    */
    HAL_GPIO_DeInit(GPIOB, USB2_VBUS_Pin|USB2_D__Pin|USB2_D_B15_Pin);
