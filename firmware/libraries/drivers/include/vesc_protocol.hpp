...
enum PacketID : uint8_t {
    ...
    SET_CURRENT_HANDBRAKE_REL = 0x0D,     // Set relative handbrake current
    STATUS_2 = 0x0E,                      // Status packet 2
    STATUS_3 = 0x0F,                      // Status packet 3
    STATUS_4 = 0x10,                      // Status  packet 4
    PING = 0x11,                          // Ping
    PONG = 0x12,                          // Pong
